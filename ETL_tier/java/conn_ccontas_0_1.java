package client.conn_ccontas_0_1;
...
/**
 * Job: conn_ccontas Purpose: Conector SAP x SMART - Cadastro de Contas<br>
 * Description: Conector SAP x SMART - Cadastro de Contas <br>
 * @author sergio.paes@slaterit.com
 * @version 6.2.1.20160704_1411
 * @status 
 */
public class conn_ccontas implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (estrBal != null) {
				...
				this.setProperty("estrBal", estrBal.toString());
		...
		public String estrBal;

		public String getEstrBal() {
			return this.estrBal;
		}
	...
	private final String jobName = "conn_ccontas";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(conn_ccontas.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_client_conn_ccontas = new byte[0];
		static byte[] commonByteArray_client_conn_ccontas = new byte[0];

		public String zztiporegistro1;

		public String getZztiporegistro1() {
			return this.zztiporegistro1;
		}

		public String tacodigo1;

		public String getTacodigo1() {
			return this.tacodigo1;
		}

		public String taclassificacao1;

		public String getTaclassificacao1() {
			return this.taclassificacao1;
		}

		public String tadescricao1;

		public String getTadescricao1() {
			return this.tadescricao1;
		}

		public String tagrupo1;

		public String getTagrupo1() {
			return this.tagrupo1;
		}

		public String tagrau1;

		public String getTagrau1() {
			return this.tagrau1;
		}

		public String tatipo1;

		public String getTatipo1() {
			return this.tatipo1;
		}

		public String tatotalizadora1;

		public String getTatotalizadora1() {
			return this.tatotalizadora1;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_client_conn_ccontas.length) {
					if (length < 1024
							&& commonByteArray_client_conn_ccontas.length == 0) {
						commonByteArray_client_conn_ccontas = new byte[1024];
					} else {
						commonByteArray_client_conn_ccontas = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_client_conn_ccontas, 0,
						length);
				strReturn = new String(commonByteArray_client_conn_ccontas,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_client_conn_ccontas) {

				try {

					int length = 0;

					this.zztiporegistro1 = readString(dis);

					this.tacodigo1 = readString(dis);

					this.taclassificacao1 = readString(dis);

					this.tadescricao1 = readString(dis);

					this.tagrupo1 = readString(dis);

					this.tagrau1 = readString(dis);

					this.tatipo1 = readString(dis);

					this.tatotalizadora1 = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.zztiporegistro1, dos);

				// String

				writeString(this.tacodigo1, dos);

				// String

				writeString(this.taclassificacao1, dos);

				// String

				writeString(this.tadescricao1, dos);

				// String

				writeString(this.tagrupo1, dos);

				// String

				writeString(this.tagrau1, dos);

				// String

				writeString(this.tatipo1, dos);

				// String

				writeString(this.tatotalizadora1, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("zztiporegistro1=" + zztiporegistro1);
			sb.append(",tacodigo1=" + tacodigo1);
			sb.append(",taclassificacao1=" + taclassificacao1);
			sb.append(",tadescricao1=" + tadescricao1);
			sb.append(",tagrupo1=" + tagrupo1);
			sb.append(",tagrau1=" + tagrau1);
			sb.append(",tatipo1=" + tatipo1);
			sb.append(",tatotalizadora1=" + tatotalizadora1);
			sb.append("]");
	...
	public static class T_CONTASStruct implements
			routines.system.IPersistableRow<T_CONTASStruct> {
		final static byte[] commonByteArrayLock_client_conn_ccontas = new byte[0];
		static byte[] commonByteArray_client_conn_ccontas = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(T_CONTASStruct other) {
	...
	public void tSAPInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				T_CONTASStruct T_CONTAS = new T_CONTASStruct();
				...
				String insert_tMSSqlOutput_1 = "INSERT INTO ["
						+ tableName_tMSSqlOutput_1
						+ "] ([zztiporegistro],[tacodigo],[taclassificacao],[tadescricao],[tagrupo],[tagrau],[tatipo],[tatotalizadora]) VALUES (?,?,?,?,?,?,?,?)";
				...
				final class Helper_tReplaceNull_1 {
					...
					public void fill(outSMARTStruct input_row,
						...
						output_row.zztiporegistro1 = (String) coalesce(
								input_row.zztiporegistro1, ' ', null, "");
						output_row.tacodigo1 = (String) coalesce(
								input_row.tacodigo1, ' ', null, "");
						output_row.taclassificacao1 = (String) coalesce(
								input_row.taclassificacao1, ' ', null, "");
						output_row.tadescricao1 = (String) coalesce(
								input_row.tadescricao1, ' ', null, "");
						output_row.tagrupo1 = (String) coalesce(
								input_row.tagrupo1, ' ', null, "");
						output_row.tagrau1 = (String) coalesce(
								input_row.tagrau1, ' ', null, "");
						output_row.tatipo1 = (String) coalesce(
								input_row.tatipo1, ' ', null, "");
						output_row.tatotalizadora1 = (String) coalesce(
								input_row.tatotalizadora1, ' ', null, "");
					} // end of fill
				...
				com.sap.conn.jco.JCoFunctionTemplate functionTemplate_tSAPInput_1 = repository_tSAPInput_1
						.getFunctionTemplate("ZMSAF_CAD_CONTAS");
				...
				importParameterList_tSAPInput_1.setValue("I_KTOPL",
						context.estrBal); // "input_single"
				...
				boolean go_T_CONTAS = true;

				com.sap.conn.jco.JCoTable table_T_CONTAS_tSAPInput_1 = tableParameterList_tSAPInput_1
						.getTable("T_CONTAS");

				go_T_CONTAS = !table_T_CONTAS_tSAPInput_1.isEmpty();
				...
				go_T_CONTAS) {
					...
					if (go_T_CONTAS) {
						...
						if (table_T_CONTAS_tSAPInput_1.isLastRow()) { // check
																		// the
																		// flag
																		// first
							go_T_CONTAS = false;
						}
						T_CONTAS = new T_CONTASStruct();

						// "table_output" or "output_table"--zztiporegistro1

						T_CONTAS.zztiporegistro1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("ZZTIPOREGISTRO"));

						// "table_output" or "output_table"--tacodigo1

						T_CONTAS.tacodigo1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("TACODIGO"));

						// "table_output" or "output_table"--taclassificacao1

						T_CONTAS.taclassificacao1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("TACLASSIFICACAO"));

						// "table_output" or "output_table"--tadescricao1

						T_CONTAS.tadescricao1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("TADESCRICAO"));

						// "table_output" or "output_table"--tagrupo1

						T_CONTAS.tagrupo1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("TAGRUPO"));

						// "table_output" or "output_table"--tagrau1

						T_CONTAS.tagrau1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("TAGRAU"));

						// "table_output" or "output_table"--tatipo1

						T_CONTAS.tatipo1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("TATIPO"));

						// "table_output" or "output_table"--tatotalizadora1

						T_CONTAS.tatotalizadora1 = ParserUtils
								.parseTo_String(table_T_CONTAS_tSAPInput_1
										.getString("TATOTALIZADORA"));

						if (go_T_CONTAS) {
							table_T_CONTAS_tSAPInput_1.nextRow();
						}
					...
					if (T_CONTAS != null) {
						...
						{ // start of Var scope
							...
							outSMART_tmp.zztiporegistro1 = T_CONTAS.zztiporegistro1;
							outSMART_tmp.tacodigo1 = T_CONTAS.tacodigo1;
							outSMART_tmp.taclassificacao1 = T_CONTAS.taclassificacao1;
							outSMART_tmp.tadescricao1 = T_CONTAS.tadescricao1;
							outSMART_tmp.tagrupo1 = T_CONTAS.tagrupo1;
							outSMART_tmp.tagrau1 = T_CONTAS.tagrau1;
							outSMART_tmp.tatipo1 = T_CONTAS.tatipo1;
							outSMART_tmp.tatotalizadora1 = T_CONTAS.tatotalizadora1;
						...
						if (outSMART != null) {
							...
							if (row1.zztiporegistro1 == null) {
								pstmt_tMSSqlOutput_1.setNull(1,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMSSqlOutput_1.setString(1,
										row1.zztiporegistro1);
							}

							if (row1.tacodigo1 == null) {
							...
							if (row1.taclassificacao1 == null) {
								pstmt_tMSSqlOutput_1.setNull(3,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMSSqlOutput_1.setString(3,
										row1.taclassificacao1);
							}

							if (row1.tadescricao1 == null) {
							...
							if (row1.tagrupo1 == null) {
								pstmt_tMSSqlOutput_1.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMSSqlOutput_1
										.setString(5, row1.tagrupo1);
							}

							if (row1.tagrau1 == null) {
								pstmt_tMSSqlOutput_1.setNull(6,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMSSqlOutput_1.setString(6, row1.tagrau1);
							}

							if (row1.tatipo1 == null) {
								pstmt_tMSSqlOutput_1.setNull(7,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMSSqlOutput_1.setString(7, row1.tatipo1);
							}

							if (row1.tatotalizadora1 == null) {
								pstmt_tMSSqlOutput_1.setNull(8,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMSSqlOutput_1.setString(8,
										row1.tatotalizadora1);
							}
	...
	public static void main(String[] args) {
		final conn_ccontas conn_ccontasClass = new conn_ccontas();

		int exitCode = conn_ccontasClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = conn_ccontas.class.getClassLoader()
					.getResourceAsStream(
							"client/conn_ccontas_0_1/contexts/"
			...
			context.estrBal = (String) context.getProperty("estrBal");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			if (parentContextMap.containsKey("estrBal")) {
				context.estrBal = (String) parentContextMap.get("estrBal");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : conn_ccontas");
		}
...
/************************************************************************************************
 * 68688 characters generated by Talend Open Studio for Data Integration on the
 * 28 de Fevereiro de 2019 13h37min19s BRT
 ************************************************************************************************/
